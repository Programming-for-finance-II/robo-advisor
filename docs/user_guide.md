...
7. [Step 5 — Backtesting](#step-5--backtesting)
8. [Step 6 — Compare Markowitz](#step-6--compare-markowitz)
...
1. Navigate to *Chat Advisor* in the top navigation bar.
